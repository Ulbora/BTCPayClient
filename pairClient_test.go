...
// func TestBTCPayClient_PairClientLiveToken(t *testing.T) {
// 	//-----------used to generate real token on real test store-----
...
// 	// pcodeURL := c.GetPairingCodeRequest(presp.Data[0].ParingCode)
// 	pcodeURL := c.GetPairingCodeRequest(resp.Data[0].ParingCode)
